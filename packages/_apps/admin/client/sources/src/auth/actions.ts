...
export const AuthActions = {
    ...
    LoadCurrentUserSuccess: (currentUser: any) => createAction(AuthActionsTypes.LoadCurrentUserSuccess, currentUser),
    Authenticate: (authValues: { email: string; password: string; remeberMe: boolean }) =>
        createAction(AuthActionsTypes.Authenticate, authValues),
    AuthenticateErrors: (errors: any) => createAction(AuthActionsTypes.AuthenticateErrors, errors),
};
